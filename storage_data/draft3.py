...
def spider_mdelive():
    with open("D:/urls_case.csv", "r") as urls:
        count = 0
        articles = []
        for temp_url in islice(urls, 0, None):
            url = f"http://case.medlive.cn" + temp_url
            try:
            ...
            content = "".join(html.xpath('.//div[@class="content_body"]//span/text()'))
...
def save_to_csv(articles):
    with open("D:/医脉通_病例读片.csv", "a", newline='', encoding="utf_8_sig") as file:
